// --------------------------------------------------------------------------
// <copyright file="OdbcZohoCrmPrimaryKeysTool.cs" company="Devart">
//
...
{
  internal sealed class OdbcZohoCrmPrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
