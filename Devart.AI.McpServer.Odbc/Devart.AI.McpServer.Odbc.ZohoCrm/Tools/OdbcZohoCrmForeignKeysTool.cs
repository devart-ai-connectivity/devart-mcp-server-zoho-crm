// --------------------------------------------------------------------------
// <copyright file="OdbcZohoCrmForeignKeysTool.cs" company="Devart">
//
...
namespace Devart.AI.McpServer.Odbc.ZohoCrm.Tools
{
  internal sealed class OdbcZohoCrmForeignKeysTool(McpConfiguration serverConfiguration) : ForeignKeysTool(serverConfiguration)
  {
